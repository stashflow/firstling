      ...
      <main className="min-h-screen bg-[#f4f5f4] px-4 py-6 text-[#101211] sm:px-8">
        <div className="mx-auto flex min-h-[calc(100vh-48px)] max-w-5xl flex-col">
          ...
          <div className="grid flex-1 place-items-center py-10">
            <Card className="w-full max-w-3xl p-8 text-center sm:p-10">
              <div className="mx-auto grid size-16 place-items-center rounded-[1.4rem] bg-[#34c759] text-white shadow-[0_18px_45px_rgba(52,199,89,0.32)]">
              ...
              <p className="mx-auto mt-5 max-w-2xl text-lg font-bold leading-snug text-black/55">
                Clerk live keys are missing in production, so the sign-in form
                cannot load yet. Once `NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY` and
                `CLERK_SECRET_KEY` are set in Vercel, this page will start
                working.
              </p>
            </Card>
          </div>
